...
** Robot basketball rules allow for a diameter of up to 35 cm and height of up to 35 cm,
but smaller robot uses less material and fits more easily into boxes.
