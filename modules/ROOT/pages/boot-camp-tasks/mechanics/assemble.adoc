...
. In Autodesk Fusion, click File > Open, in the prompt click "Open from my computer..."
. Select the STEP file that you saved earlier.
. The model will be opened, save the model so it can be used with Autodesk Fusion.
