...
. Created checklist pages to replace review summary pages.

=== 2025-11-01

. Created the KiCad page with information about routing differential pairs.
...
. Added a git flowchart to illustrate feature branches.
. Added a link to the NoMachine homepage.
. Added additional comment that the dummy adapter will break the computers display output.

=== 2025-09-04

. Created a page about writing documentation.

=== 2025-09-01

. Created the "Useful links and other resources" page for programming.

=== 2024-11-18

. Created the Digilab milling page.
