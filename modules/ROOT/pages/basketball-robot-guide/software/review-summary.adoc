...
*TL;DR:* It is better to keep the scope of code changes small and focused to make reviews fast and fixes easy.
...
*TL;DR:* Similar coding practices make understanding code simpler for reviewers and future readers of code.
